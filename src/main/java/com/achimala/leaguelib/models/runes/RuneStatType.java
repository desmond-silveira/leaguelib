...
public enum RuneStatType {
    ...
    CRITICAL_DAMAGE("FlatCritDamageMod", "critical damage", false),
    ...
    CRITICAL_DAMAGE_PER_LEVEL("rFlatCritDamageModPerLevel", "critical damage/level", false),
    ...
    CRITICAL_CHANCE_PER_LEVEL("rFlatCritChanceModPerLevel", "critical chance/level", false),
    ...
    CRITICAL_CHANCE("FlatCritChanceMod", "critical chance", false),
